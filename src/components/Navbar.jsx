...
const Navbar = () => {
    ...
    return (
        ...
        <div className="flex justify-between items-center m-2 p-2 text-xl font-semibold">
            ...
            <span className="flex justify-center items-center gap-2 mr-[2rem]"> Cart Item:{items.length} <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
